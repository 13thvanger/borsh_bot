...
DEFAULT_MESSAGES = {
    ...
    "no_photo.txt": [
        "📸 Сначала пришли свежее фото борща, потом жми /borsh. Или ответь /borsh на нужное фото.",
        "🥄 Фото не найдено. Отправь свежий снимок борща или ответь командой /borsh на свое фото.",
    ],
    "already_counted.txt": [
    ...
    "agent_timeout_bypass.txt": [
        "⏱ ИИ-инспектор не ответил вовремя, поэтому верим фото на слово. +1 борщ!",
        "🍲 Агент ушел в таймаут. Борщ засчитан в режиме доверия. +1!",
    ],
}
